              ...
              {blog.content.conclusion && (
                <div className="pt-8 sm:pt-10 pt-6 sm:pt-8 border-t border-gray-200">
                  <div className="flex items-center gap-3 pb-4 sm:pb-6">
                    ...
                    <h2 className="text-xl sm:text-2xl lg:text-3xl font-serif text-[#1a365d]">Conclusion</h2>
                  </div>
                  <div className="bg-gradient-to-br from-[#fcf6f2] to-white rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-gray-100">
                    <p className="text-gray-700 leading-relaxed text-sm sm:text-base lg:text-lg">{blog.content.conclusion}</p>
                  </div>
                </div>
              )}
            </div>
            ...
            {blog.images && blog.images.length > 1 && (
              <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-100 shadow-sm">
                <div className="flex items-center gap-3 pb-4 sm:pb-6">
                  ...
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-serif text-[#1a365d]">Visual Journey</h2>
                </div>
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3 lg:gap-4">
                  {blog.images.slice(1).map((image, index) => (
                    <div key={index} className="aspect-square rounded-lg sm:rounded-xl overflow-hidden group cursor-pointer">
                      <img
                        src={image}
