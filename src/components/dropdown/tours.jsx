            ...
            <div className="grid grid-cols-3 gap-6">
              {activeCategory.subcategories.map((tour) => (
                <Link
                  ...
                  onClick={onClose}
                  className="group relative bg-white rounded-2xl p-4 border border-[#eee2d8] transition-all duration-300 hover:-translate-y-1 hover:border-amber-400 hover:shadow-2xl hover:shadow-black/10"
                >
